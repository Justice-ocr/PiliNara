...
typedef WindowsNeoThemeTokenBuilder =
    WindowsNeoTokens Function(
      ThemeData theme,
...
abstract final class WindowsNeoThemeRegistry {
  ...
  static WindowsNeoTokens _buildEndfieldTokens(
    ...
    return WindowsNeoTokens(
      ...
      secondaryAccent: isDark
          ? const Color(0xFFF4F4EE)
          : const Color(0xFF191919),
      tertiaryAccent: isDark
          ? const Color(0xFF565650)
          : const Color(0xFF96968D),
  ...
  static WindowsNeoTokens _buildArkTokens(
    ...
    return WindowsNeoTokens(
      ...
      tertiaryAccent: isDark
          ? const Color(0xFF476166)
          : const Color(0xFFB8CBCD),
  ...
  static WindowsNeoTokens _buildExAstrisTokens(
    ...
    return WindowsNeoTokens(
      ...
      tertiaryAccent: isDark
          ? const Color(0xFF51557A)
          : const Color(0xFFD7D6EA),
...
class WindowsNeoTokens extends ThemeExtension<WindowsNeoTokens> {
  ...
  /// Most Ark UI families treat rectangular surfaces as instrumentation, not
  /// soft cards. Curvature is reserved for Miku, POPUCOM, and Ex Astris's
  ...
  BorderRadius get workspaceTabRadius => switch (family) {
    ...
    WindowsNeoThemeFamily.popucom => BorderRadius.circular(10),
    _ => BorderRadius.zero,
  };

  BorderRadius get sidebarArtworkRadius => switch (family) {
    WindowsNeoThemeFamily.miku => BorderRadius.circular(8),
    WindowsNeoThemeFamily.popucom => BorderRadius.circular(14),
    _ => BorderRadius.zero,
  };
  ...
  BorderRadius get mediaBadgeRadius => switch (family) {
    ...
    WindowsNeoThemeFamily.exAstris => BorderRadius.circular(999),
    WindowsNeoThemeFamily.popucom => BorderRadius.circular(8),
    _ => BorderRadius.zero,
  };
  ...
  BorderRadius get actionRadius => switch (family) {
    WindowsNeoThemeFamily.miku => BorderRadius.circular(6),
    WindowsNeoThemeFamily.exAstris => BorderRadius.circular(999),
    WindowsNeoThemeFamily.popucom => BorderRadius.circular(12),
  ...
  List<String> get displayFontFallback => switch (family) {
    ...
    WindowsNeoThemeFamily.endfield => const ['Space Grotesk', 'IBM Plex Sans'],
    ...
    WindowsNeoThemeFamily.corporate => const ['Space Grotesk', 'IBM Plex Sans'],
  ...
  Color get navigationSurface => switch (family) {
    ...
    WindowsNeoThemeFamily.corporate => chromeSurface,
    _ => sidebar,
  };
